...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/eugene-blog-og.png`;
  let appOgImageAlt = "Eugene Rosario's Blog";
